...
import 'package:reciclon_client/src/pages/recolector/ordenes/lista/recolector_ordenes_lista_controller.dart';
import 'package:reciclon_client/src/utils/my_colors.dart';
import 'package:reciclon_client/src/widgets/no_data_widget.dart';

class RecolectorOrdenesListaPage extends StatefulWidget {
  const RecolectorOrdenesListaPage({Key? key}) : super(key: key);

  @override
  State<RecolectorOrdenesListaPage> createState() =>
      _RecolectorOrdenesListaPageState();
}

class _RecolectorOrdenesListaPageState
    extends State<RecolectorOrdenesListaPage> {
  final _controller = RecolectorOrdenesListaController();
...
class _Drawer extends StatelessWidget {
  ...
  final RecolectorOrdenesListaController controlador;
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  onTap: () => controlador.goToEditProfile(),
                ),
                // ListTile(
